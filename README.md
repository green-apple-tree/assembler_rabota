#Учебная Виртуальная Машина (УВМ) — Вариант 10Проект реализует инструментарий для работы с учебной виртуальной машиной (УВМ) согласно заданию №10. В состав входят: ассемблер, интерпретатор, модуль автоматического тестирования и графическая среда разработки (IDE).
