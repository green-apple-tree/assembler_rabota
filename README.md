...
## Структура проекта
* **`assembler.py`** - Ассемблер. Транслирует исходный код в бинарный файл. В режиме тестирования выводит промежуточное представление (IR) и шестнадцатеричный дамп команд.
